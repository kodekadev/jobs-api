  ...
  async login(emailRaw: string, password: string) {
    ...
    const rows = await this.bq.query<any>(`
      SELECT
        ...
        pf.RUT, pf.FECHA_NACIMIENTO, pf.EMPRESA,
        pf.ANIO_INICIO, pf.ACTUALMENTE_TRABAJANDO, pf.ANIO_FIN,
        pf.NIVEL_EDUCATIVO, pf.INSTITUCION, pf.CARRERA,
        pf.SITUACION_ESTUDIOS, pf.ANIO_INICIO_ESTUDIOS,
  ...
  private buildResponse(u: any) {
    ...
    return {
      ...
      postula_facil: {
        ...
        empresa: u.EMPRESA || '',
        anio_inicio: u.ANIO_INICIO ? String(u.ANIO_INICIO) : '',
        actualmente_trabajando: u.ACTUALMENTE_TRABAJANDO ?? true,
        anio_fin: u.ANIO_FIN ? String(u.ANIO_FIN) : '',
        nivel_educativo: u.NIVEL_EDUCATIVO || '',
        institucion: u.INSTITUCION || '',
        carrera: u.CARRERA || '',
        situacion_estudios: u.SITUACION_ESTUDIOS || '',
        anio_inicio_estudios: u.ANIO_INICIO_ESTUDIOS ? String(u.ANIO_INICIO_ESTUDIOS) : '',
      },
      postulaciones_auto: {
