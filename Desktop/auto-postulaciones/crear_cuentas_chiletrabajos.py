"""
Crea cuentas en ChileTrabajos para todos los usuarios de Postula Fácil.

Ejecutar:
    python crear_cuentas_chiletrabajos.py           # todos los usuarios
    python crear_cuentas_chiletrabajos.py jobs8     # solo un usuario
"""
...
def _run():
    ...
    print(f"[chiletrabajos] {len(all_users)} usuario(s)")
    ok, skip, fail = 0, 0, 0
    ...
    print(f"\n[chiletrabajos] OK={ok} skip={skip} fail={fail} / {len(all_users)}")
